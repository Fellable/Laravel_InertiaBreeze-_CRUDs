<template>
    <MainLayout>
        ...
        <div class="mb-2">
            <Link :href="route('post.index')" class=" text-sm text-sky-500 mb-8">Back</Link>
        </div>
        ...
        <form @submit.prevent="store">
            ...
            <div class="mb-4">
                <button class="hover:bg-white hover:text-sky-500 border border-sky-500
            block p-2 w-32 bg-sky-500 rounded-full text-center text-white ml-auto" type="submit"> Store
                </button>
            </div>
        </form>
    </MainLayout>
